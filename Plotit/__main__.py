from numpy import arange, sin, pi, exp, log, tan, floor, ceil, i0 
import numpy as np
...
class MyFrame(wx.Frame):
        def __init__(self, parent, title):
            ...
            #Creating an array
            names = ["SELECT RANGE","sin(x)", "logx", "exp(x)","Modified Bessel function of the first kind, order 0", "floor", "ceil"]
